...
class FavoritesTableTableViewController: UITableViewController {
    ...
    override func viewDidLoad() {
        ...
        refreshControl?.addTarget(self, action: #selector(FavoritesTableTableViewController.refreshTableView), forControlEvents: UIControlEvents.ValueChanged)
    ...
    override func tableView(tableView: UITableView, cellForRowAtIndexPath indexPath: NSIndexPath) -> UITableViewCell {
        ...
        if cellProtected == true {
            cell.nameLabel?.text = cellUserName + "  　鍵垢の人です"
        } else {
